            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <ul>
                        ...
                        <li><b><i>gsm_external_ip</i></b>: Externe IPv4-Adresse (Providerseite)</li>
                        <li><b><i>gsm_external_ip6</i></b>: Externe IPv6-Adresse (Providerseite)</li>
        ...
        if ($data4WoMo_params['value'] != 'N/A') {
            ...
            switch(strtolower($data4WoMo_params['value'])){
                ...
                case "gsm_external_ip":
                    ...
                    break;
                case "gsm_external_ip6":
                    $data4WoMo_sql = "SELECT sim_ip6 AS Value FROM gsm_data ORDER BY created_at DESC LIMIT 1;";
                    break;                    
            ...
            if ($data4WoMo_params['table'] != 'N/A') {
                ...
                switch(strtolower($data4WoMo_params['table'])) {
                    ...
                    case "reisen_env_innen":
                        $data4WoMo_sql = "SELECT name, CONCAT((select ROUND(temperature,1) from environment_data where sensor_id=9 and created_at > journey_begins + INTERVAL 3 HOUR and created_at < journey_ends order by temperature ASC LIMIT 1),' °C') as inside_tempmin, CONCAT((select ROUND(temperature,1) from environment_data where sensor_id=9 and created_at > journey_begins + INTERVAL 3 HOUR and created_at < journey_ends order by temperature DESC LIMIT 1),' °C') as inside_tempmax, CONCAT((select ROUND(AVG(temperature),1) from environment_data where sensor_id=9 and created_at > journey_begins + INTERVAL 3 HOUR and created_at < journey_ends),' °C') as inside_tempavg, CONCAT((select ROUND(humidity,0) from environment_data where sensor_id=9 and created_at > journey_begins + INTERVAL 3 HOUR and created_at < journey_ends order by humidity ASC LIMIT 1),' %') as inside_hummin, CONCAT((select ROUND(humidity,0) from environment_data where sensor_id=9 and created_at > journey_begins + INTERVAL 3 HOUR and created_at < journey_ends order by humidity DESC LIMIT 1),' %') as inside_hummax, CONCAT((select ROUND(AVG(humidity),0) from environment_data where sensor_id=9 and created_at > journey_begins + INTERVAL 3 HOUR and created_at < journey_ends),' %') as inside_humavg FROM journeys where id != 8 order by journey_begins ASC;";
                    ...
                    case "reisen_env_aussen":
                        $data4WoMo_sql = "SELECT name, CONCAT((select ROUND(temperature,1) from environment_data where sensor_id=16 and created_at > journey_begins and created_at < journey_ends order by temperature ASC LIMIT 1),' °C') as inside_tempmin, CONCAT((select ROUND(temperature,1) from environment_data where sensor_id=16 and created_at > journey_begins and created_at < journey_ends order by temperature DESC LIMIT 1),' °C') as inside_tempmax, CONCAT((select ROUND(AVG(temperature),1) from environment_data where sensor_id=16 and created_at > journey_begins and created_at < journey_ends),' °C') as inside_tempavg, CONCAT((select ROUND(humidity,0) from environment_data where sensor_id=16 and created_at > journey_begins and created_at < journey_ends order by humidity ASC LIMIT 1),' %') as inside_hummin, CONCAT((select ROUND(humidity,0) from environment_data where sensor_id=16 and created_at > journey_begins and created_at < journey_ends order by humidity DESC LIMIT 1),' %') as inside_hummax, CONCAT((select ROUND(AVG(humidity),0) from environment_data where sensor_id=16 and created_at > journey_begins and created_at < journey_ends),' %') as inside_humavg FROM journeys where id != 8 order by journey_begins ASC;";
                        $data4WoMo_sql_field_list = ["name", "inside_tempmin", "inside_tempavg", "inside_tempmax", "inside_hummin", "inside_humavg", "inside_hummax"];
                        $dataWoMo_return_HTML = "<table border=0><tr><td width='40%'></td><td colspan='3' width='30%'><center><h5>Temperatur<br>Aussen (50cm über Boden)</h5></center></td><td colspan='3' width='30%'><center><h5>Luftfeuchtigkeit<br>Aussen (50cm über Boden)</h5></center></td></tr><tr><td width='40%'><h5>Name</h5></td><td with='10%'><center><b>Min</b></center></td><td with='10%'><center><b>Durch.</b></center></td><td with='10%'><center><b>Max</b></center></td><td with='10%'><center><b>Min</b></center></td><td with='10%'><center><b>Durch.</b></center></td><td with='10%'><center><b>Max</b></center></td><tr>";
                        $dataWoMo_row_HTML = "<tr><td>[[name]]</td><td><center>[[inside_tempmin]]</center></td><td><center>[[inside_tempavg]]</center></td><td><center>[[inside_tempmax]]</center></td><td><center>[[inside_hummin]]</center></td><td><center>[[inside_humavg]]</center></td><td><center>[[inside_hummax]]</center></td></tr>";
                        break;
                    default:
